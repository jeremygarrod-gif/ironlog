...
// Google sign-in needs an OAuth client in Google Cloud Console and the Google
// provider switched on in Supabase. Until both are done, the button has to stay
// hidden: signInWithOAuth redirects the browser before any of our code runs, so
// a misconfigured provider dumps raw JSON on a blank page rather than raising an
// error we could catch and explain. Flip this to true once it's set up — see
